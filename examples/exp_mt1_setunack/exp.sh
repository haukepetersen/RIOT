...
sleep 3
tmux send-keys -t riot-${EXPID}:2 "nrf52dk-2;run" C-m
sleep 0.1
tmux send-keys -t riot-${EXPID}:2 "nrf52dk-3;run" C-m
sleep 0.1
tmux send-keys -t riot-${EXPID}:2 "nrf52dk-4;run" C-m
sleep 0.1
tmux send-keys -t riot-${EXPID}:2 "nrf52dk-5;run" C-m
sleep 0.1
tmux send-keys -t riot-${EXPID}:2 "nrf52dk-6;run" C-m
sleep 0.1
tmux send-keys -t riot-${EXPID}:2 "nrf52dk-7;run" C-m
sleep 0.1
tmux send-keys -t riot-${EXPID}:2 "nrf52dk-8;run" C-m
sleep 0.1
tmux send-keys -t riot-${EXPID}:2 "nrf52dk-9;run" C-m
sleep 0.1
