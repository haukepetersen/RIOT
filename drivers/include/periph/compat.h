 ...
 * @{
 * @file
 * @brief       Temporary compatibility header for peripheral types
 *
 * TODO: Remove one all CPUs have move to new GPIO driver
 *
...
#else
/**
 * @brief   Define to int to prevent compilation errors
 */
typedef int gpio_t;
#endif

/**
 * @brief   Generic MUX type
 */
typedef int gpio_mux_t;

/**
 * @brief   Define mandatory macro for defining pins
 *
 * The first argument is used but thrown away to prevent compile errors
 */
