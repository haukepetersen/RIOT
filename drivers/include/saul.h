 ...
 *
 * SAUL is a generic actuator/sensor interface in RIOT. It's purpose is to
 ...
 *
 * Each device implementing this interface has to expose a set of predefined
 * functions and it has to register itself to the central SAUL registry. From
 * here devices can be found, listed, and accessed.
 *
