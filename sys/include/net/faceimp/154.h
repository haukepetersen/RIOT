...
/**
 * @defgroup    net_facemaster_faceimp_154 Netdev-based IEEE802.15.4 Imp
 * @ingroup     net_facemaster_faceimp
 * @brief       TODO
 * @{
 *
 * @file
 * @brief       Face implementation for IEEE802.15.4
 *
...
#ifndef NET_FACEIMP_154_H
#define NET_FACEIMP_154_H
...
#ifndef FACEIMP_154_THREAD_PRIO
#define FACEIMP_154_THREAD_PRIO             (THREAD_PRIORITY_MAIN - 5)
#endif

#ifndef FACEIMP_154_STACKSIZE
#define FACEIMP_154_STACKSIZE               (THREAD_STACKSIZE_DEFAULT)
#endif

/* NOTE: must be power of 2 */
#ifndef FACEIMP_154_MSGQSIZE
#define FACEIMP_154_MSGQSIZE                 (16U)
#endif

#ifndef FACEIMP_154_ADDRLEN
#define FACEIMP_154_ADDRLEN                 (IEEE802154_SHORT_ADDRESS_LEN)
#endif
