...
static void cmd_temp_test(int argc, char **argv);
...
static const shell_command_t shell_commands[] = {
    { "tt", "temporary test location", cmd_temp_test },
 ...
 */
void cmd_temp_test(int argc, char **argv)
{
    ...
    while (1) {
        gpio_clear(GPIO_7);
        spi_transfer_byte(TESTPORT_MASTER, 0x99, 0);
        gpio_set(GPIO_7);
    }
}
