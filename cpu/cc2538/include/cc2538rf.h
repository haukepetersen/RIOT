...
/**
 * @brief   CC2538RF radio device descriptor (base on netdev2)
 */
typedef struct {
    /* netdev2 fields */
...
/**
 * @brief   Export the netdev2 driver interface
 */
extern const netdev2_driver_t cc2538rf_driver;

/**
 * @brief   Pre-initialize the cc2538rf radio
 *
...
/**
 * @brief   Initialize the cc2538rf radio
 */
 ...
 *
 * @return  channel that is currently configured
 */
