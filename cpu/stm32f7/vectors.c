...
#if defined(CPU_MODEL_STM32F769NI) || defined(CPU_MODEL_STM32F767ZI)
    [99]  = isr_dfsdm1_flt0,          /* [99] DFSDM1 Filter 0 global Interrupt */
    [100] = isr_dfsdm1_flt1,          /* [100] DFSDM1 Filter 1 global Interrupt */
    [101] = isr_dfsdm1_flt2,          /* [101] DFSDM1 Filter 2 global Interrupt */
    [102] = isr_dfsdm1_flt3,          /* [102] DFSDM1 Filter 3 global Interrupt */
#endif

#if defined(CPU_MODEL_STM32F769NI) || defined(CPU_MODEL_STM32F767ZI) || \
    defined(CPU_MODEL_STM32F722ZE)
    [103] = isr_sdmmc2,               /* [103] SDMMC2 global Interrup */
#endif
